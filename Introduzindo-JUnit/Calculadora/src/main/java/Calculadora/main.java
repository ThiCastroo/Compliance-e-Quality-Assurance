	...
	public static void main(String[] args) {
		...
		switch (opcao) {
			...
			case 2:
				...
				System.out.println("O resultado da subtracao de "+ valor2 + " de " + valor1 + " é: " + resultado);
				break;
			case 3:
				resultado = calc.multiplicar(valor1, valor2);
				System.out.println("O resultado da multiplicação de "+ valor1 + " por " + valor2 + " é: " + resultado);
				break;
			case 4:
				resultado = calc.dividir(valor1, valor2);
				System.out.println("O resultado da divisao de "+ valor1 + " por " + valor2 + " é: " + resultado);
				break;
		}
